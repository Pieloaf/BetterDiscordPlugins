...
module.exports = ((_) => {
    ...
    return class {
        ...
        observer(mutationRecord) {
            const serverList =
                document.querySelector(guildBarSelector).firstChild
                    .childNodes[1];
            const serverListSelector = createSelector(
                serverList.classList.value
            );
        ...
        initialise(serverListNode) {
            ...
            let serverList =
                ...
                document.querySelector(guildBarSelector).firstChild
                    .childNodes[1];
            serverList.insertBefore(
                sidebarBtn,
                serverList.firstElementChild.nextSibling
            );
        }
    };
})();
